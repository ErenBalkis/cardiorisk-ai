...
# 2. Aykırı Değer (Outlier) Temizliği
...
print(f"Model başarıyla eğitildi. Test Accuracy: {accuracy_score(y_test, y_pred):.4f}")

# 7. Model ve Bileşenlerini Dışa Aktarma (Export)
joblib.dump(model, "heart_disease_model.pkl")
joblib.dump(scaler, "scaler.pkl")
joblib.dump(list(X_train.columns), "model_columns.pkl")
print("'.pkl' dosyaları başarıyla oluşturuldu ve kaydedildi!")